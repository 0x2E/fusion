...
EXPOSE 8080
VOLUME ["/data"]
# SQLite default path (used when FUSION_DATABASE_URL is not set)
ENV DB="/data/fusion.db"
# PostgreSQL: set FUSION_DATABASE_URL=postgres://user:pass@host:5432/db?sslmode=disable to use PostgreSQL instead
